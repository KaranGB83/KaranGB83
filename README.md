...
| 📈 | **StockSeener** | Python CLI tool for screening NSE & BSE listed Indian stocks — covers live price, fundamentals (ROE, P/E, EPS, Debt/Equity), multi-horizon historical returns, and an automated buy/caution signal | `Python` `yfinance` `pandas` `financetoolkit` `pytest` | [Repo →](https://github.com/KaranGB83/StockSeener) |
...
&nbsp;
[![GitHub](https://img.shields.io/badge/GitHub-%23181717.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/KaranGB83)
...
![Profile Views](https://komarev.com/ghpvc/?username=KaranGB83&color=6E40C9&style=flat-square&label=Profile+Views)
